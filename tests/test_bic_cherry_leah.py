...
from bic_cherry_leah import (
    bic_cherry,
    bic_cherry_network_initialization,
    different_color_pairs
)
import pytest
...
# test bic cherry initialization
def test_bic_cherry(sample_bmg_1):

    cherry_network  = bic_cherry_network_initialization(sample_bmg_1)
    pairs = different_color_pairs(sample_bmg_1)
...
def test_bic_cherry_extension(sample_bmg_1):
    network = bic_cherry(sample_bmg_1)
...
def test_bic_cherry_generated_examples():
    ...
    for i in range(10):
        ...
        cherry_network = bic_cherry_network_initialization(bmg)
        pairs = different_color_pairs(bmg)
...
def test_bic_cherry_extension_generated_examples():
    ...
    for i in range(10):
        ...
        tree = create_gene_tree(species, species_tree_age).gene_tree
        bmg = bmg_from_network(tree)
        network = bic_cherry_network_initialization(bmg)
...
def test_bmg_extra(sample_bmg_2):
    ...
    network = bic_cherry(sample_bmg_2)
